...
async def fetch_work_items(organization: str, project: str, repository: str, start_date: str, end_date: str) -> List[dict]:
    ...
    params = {
        'searchCriteria.itemVersionVersion': start_date, #TODO: is this param correct?
    ...
    try:
        ...
        response = await make_request(url=base_url, method='GET', headers=headers, data=params)
